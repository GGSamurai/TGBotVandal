...
async def echo(message: Message):
    ...
    if msg == 'районы': #Если пользователь нажал на кнопку "Районы", то
        ...
        await message.answer(f'Выберите доступные адреса по району', reply_markup=keyboard.street_kb_vor) #Показываем адреса по выбранному району (Стандартно стоит Ворошиловский)"
